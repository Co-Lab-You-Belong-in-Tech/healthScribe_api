...
HealthScribe helps users easily record and visualize their health and symptom triggers, so that users as well as their doctors can identify patterns and isolate potential causes for various health issues.
...
```
 git clone https://github.com/Co-Lab-You-Belong-in-Tech/healthScribe_api.git
```
