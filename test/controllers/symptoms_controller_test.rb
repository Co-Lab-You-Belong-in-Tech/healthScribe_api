...
class SymptomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create symptom" do
    assert_difference("Symptom.count") do
      post symptoms_url, params: { symptom: { description: @symptom.description, name: @symptom.name, treatment: @symptom.treatment } }, as: :json
    end
  ...
  test "should update symptom" do
    patch symptom_url(@symptom), params: { symptom: { description: @symptom.description, name: @symptom.name, treatment: @symptom.treatment } }, as: :json
    assert_response :success
  end
